...
class CloudSender:
    ...
    def _send_legacy(data):
        ...
        if data.get('power') is not None: endpoint = "/add_power"
        elif data.get('lux') is not None: endpoint = "/add_lux"
        ...
        elif data.get('humidity') is not None: endpoint = "/add_humidity_temp"
